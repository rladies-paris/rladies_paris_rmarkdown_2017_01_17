---
title             : "Untidy Long Paper Example"
shorttitle        : "Untidy"
...
```{r ReadData}
# We first want to read in the data we are going to use. For simplicity, I am sticking with a dataset that comes with R and with made-up data. 
# In a "normal" report, you would have a data folder and read in from there (cf. RMarkdownExample on comic book data)
...
# Now we need to whip the data into shape for analyses and plotting. This might involve removing outliers etc so this section can be quite lengthy
...
```{r  fig.cap = "Barplots of one dimension of Anscombe's Quartet"}
